...
%%
function [x,x_stack]  = CE_MBIR_3d(A,AT,b,x0 ,G , denoiser,lambda,alpha,sigma2 , rho ,niter,bpos)

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% CE_MBIR
%       [x,x_stack] = CE_MBIR_3d(A,AT,b,x0 ,G ,denoiser,lambda, alpha,niter,bpos)
% This function implements CE_MBIR algorithm of Algorithm. 3 for 3D
% reconstruction.
%
%   Input:
...
%         v{i}  	= v{i} + alpha*AT{i}(b{i} - A{i}(v{i}))./ATA{i} - alpha*imgradient3(v{i} - denoiser(v{i},'TV',1,lambda))/G - alpha*(v{i}-x-u{i})./sigma2;
          v{i}  	= v{i} + alpha*AT{i}(b{i} - A{i}(v{i}))./ATA{i} - alpha*imgradient3(v{i} - denoiser(v{i},lambda))/G - alpha*(v{i}-x-u{i})./sigma2;
          v{i}  	= v{i} + alpha*AT{i}(b{i} - A{i}(v{i}))./ATA{i} - alpha*imgradient3(v{i} - denoiser(v{i},lambda))/G - alpha*(v{i}-x-u{i})./sigma2;
          v{i}  	= v{i} + alpha*AT{i}(b{i} - A{i}(v{i}))./ATA{i} - alpha*imgradient3(v{i} - denoiser(v{i},lambda))/G - alpha*(v{i}-x-u{i})./sigma2;
          v{i}  	= v{i} + alpha*AT{i}(b{i} - A{i}(v{i}))./ATA{i} - alpha*imgradient3(v{i} - denoiser(v{i},lambda))/G - alpha*(v{i}-x-u{i})./sigma2;
          v{i}  	= v{i} + alpha*AT{i}(b{i} - A{i}(v{i}))./ATA{i} - alpha*imgradient3(v{i} - denoiser(v{i},lambda))/G - alpha*(v{i}-x-u{i})./sigma2;
